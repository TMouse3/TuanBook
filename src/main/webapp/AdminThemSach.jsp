...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4" style="margin-left: 260px;">
        <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
            <h3 class="text-primary fw-bold">THÊM SÁCH MỚI</h3>
            <a href="AdminQuanLySachController" class="btn btn-outline-secondary">
                ...
                <form action="AdminThemSachController" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="txtmasach" class="form-control" placeholder="Nhập mã sách..." required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Tên sách</label>
                            <input type="text" name="txttensach" class="form-control" placeholder="Nhập tên sách..." required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="txttacgia" class="form-control" placeholder="Nhập tên tác giả...">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="txtsoluong" class="form-control" min="1" value="1">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Giá (VNĐ)</label>
                            <input type="number" name="txtgia" class="form-control" min="0" placeholder="0">
                        </div>
                    </div>
